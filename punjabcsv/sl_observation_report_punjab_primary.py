...
interval = str(past_week_dt.date()) + "T11:30:00.00/" + str(current_dt.date()) + "T11:30:00.00"
...
print(df_2.select("solution_name").distinct().collect())
...
for j in range(len(df_final1)):
    ...
    for i in range(len(df_final)):
        ...
        "/home/ajay/primary_punjab_obs_report/"+program_name+"/"+solution_name+"/"
        )


# shutil.make_archive('/tmp/reports/primary_punjab_obs_report', 'zip', '/tmp/reports/obs_punjab_primary')
#
# shutil.rmtree("/tmp/reports/obs_punjab_primary")
...
# new['Subject'] = str(current_dt.date()) + "_Weekly Punjab Observation Reports for Primary Program"
