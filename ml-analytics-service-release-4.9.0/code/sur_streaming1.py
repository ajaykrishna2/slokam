                ...
                if 'answers' in obSub.keys():
                    ...
                    for ans in answersArr:
                        ...
                        def creatingObj(answer, quesexternalId, ans_val, instNumber, responseLabel):
                            ...
                            try:
                                if 'programInformation' in obSub:
                                    # print(obSub['programInformation'])
                                    surveySubQuestionsObj['programName'] = obSub['programInformation']['name']
                                else:
                            ...
                            try:
                                if 'solutionInformation' in obSub:
                                    surveySubQuestionsObj['solutionName'] = obSub['solutionInformation']['name']
                                else:
                                ...
                                surveySubQuestionsObj['solutionName'] = ''
                            # surveySubQuestionsObj['solutionName'] =None
                            # print(surveySubQuestionsObj)
                            # print(obSub['solutionInformation'].keys())
                            try:
                                section = [k for k in obSub['solutionInformation']['sections'].keys()]
                            ...
                            # print(obSub['scoringSystem'])
                            try:
                                # print(obSub['solutionInformation'])
                            ...
                            # print(answer['payload']['labels'])
                            # print(answer['responseType'])
                            ...
                            #     if 'name' in obSub['criteria']:
                            #         print(obSub['criteria']['name'])
                            #     else:
                            #         print(obSub['criteria'])
                            # surveySubQuestionsObj['criteriaExternalId'] = answer['criteriaId']
                            #
                            # surveySubQuestionsObj['criteriaName'] = None
                            print(surveySubQuestionsObj)
                        ...
                        def fetchingQuestiondetails(ansFn, instNumber):
                            ...
                            try:
                                if len(ansFn['payload']['labels']) > 0:
                                    ...
                                    final_worker = FinalWorker(ansFn, ansFn['qid'], ansFn['value'],
