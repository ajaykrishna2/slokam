...
obs_sub_df_final =dn.withColumnRenamed("d_name","district_name").withColumnRenamed("s_name","state_name").withColumnRenamed("b_name","block_name").withColumnRenamed("sch_name","school_name").withColumnRenamed("clt_name","cluster_name")
# obs_sub_df_final = dn.withColumnRenamed("s_name","school_name")
