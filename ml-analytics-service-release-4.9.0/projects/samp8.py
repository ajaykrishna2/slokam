...
for k in flat_list:
    ...
    obs_sub_dfn1.show()
    obs_sub_dfn1 = obs_sub_dfn1.select('submission_id', 'status', 'entity_externalId', 'entity_id', 'entity_type', 'user_id', 'solution_id', 'solution_externalId', 'entity_name', 'completedDate', 'program_id', 'program_externalId', 'app_name', 'private_program', 'solution_type', 'ecm_marked_na', 'updatedAt', 'role_title', 'state_externalId', 'block_externalId', 'district_externalId', 'cluster_externalId', 'school_externalId', 'channel', 'userName', 'userId', 'answers', 'parent_channel', 'board_name', 'organisation_name', 'organisation_id',  'qid', 'responseType',  'question', 'labels','completedDate',"state_name","block_name","district_name","cluster_name","school_name")
