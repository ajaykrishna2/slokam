...
projects_df_cols=projects_df_cols.select(["project_id", "project_created_type", "project_title", "project_title_editable",
...
for filename in os.listdir(config.get("OUTPUT_DIR", "project") + "/"):
    if filename.endswith(".json"):
        os.rename(
            ...
            config.get("OUTPUT_DIR", "project") + "/sl_projects1.json"
        )
